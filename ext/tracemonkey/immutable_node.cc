...
void init_Johnson_SpiderMonkey_Immutable_Node(VALUE spidermonkey)
{
  ...
  */
  ...
  rb_define_singleton_method(cNode, "parse_io", (ruby_callback)parse_io, -1);
  rb_define_method(cNode, "line", (ruby_callback)line, 0);
  rb_define_method(cNode, "index", (ruby_callback)begin_index, 0);
  rb_define_method(cNode, "pn_arity", (ruby_callback)pn_arity, 0);
  rb_define_method(cNode, "pn_type", (ruby_callback)pn_type, 0);
  rb_define_method(cNode, "pn_expr", (ruby_callback)data_pn_expr, 0);
  rb_define_method(cNode, "pn_kid", (ruby_callback)data_pn_kid, 0);
  rb_define_method(cNode, "pn_kid1", (ruby_callback)data_pn_kid1, 0);
  rb_define_method(cNode, "pn_kid2", (ruby_callback)data_pn_kid2, 0);
  rb_define_method(cNode, "pn_kid3", (ruby_callback)data_pn_kid3, 0);
  rb_define_method(cNode, "pn_dval", (ruby_callback)data_pn_dval, 0);
  rb_define_method(cNode, "pn_op", (ruby_callback)data_pn_op, 0);
  rb_define_method(cNode, "pn_left", (ruby_callback)data_pn_left, 0);
  rb_define_method(cNode, "pn_extra", (ruby_callback)data_pn_extra, 0);
  rb_define_method(cNode, "name", (ruby_callback)name, 0);
  rb_define_method(cNode, "regexp", (ruby_callback)regexp, 0);
  rb_define_method(cNode, "function_name", (ruby_callback)function_name, 0);
  rb_define_method(cNode, "function_args", (ruby_callback)function_args, 0);
  rb_define_method(cNode, "function_body", (ruby_callback)function_body, 0);
  rb_define_method(cNode, "pn_right", (ruby_callback)data_pn_right, 0);
  rb_define_method(cNode, "children", (ruby_callback)children, 0);
}
